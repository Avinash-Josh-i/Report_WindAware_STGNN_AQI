...
\begin{enumerate}
    \item To collect and preprocess PM$_{2.5}$ and meteorological data and build a wind-aware dynamic graph using distance, correlation, and wind features.
    \item To develop and evaluate baseline and GAT-GRU models for PM$_{2.5}$ forecasting and estimate pollution at unmonitored locations using virtual nodes.
    \item To provide model explainability and build a dashboard for visualizing forecasts, \gls{aqi}, spatial patterns, and explanations.
\end{enumerate}
