...
\newcommand\cDocumentType{A PROJECT PROPOSAL}
\newcommand\cTitle{EXPLAINABLE WIND-AWARE SPATIO-TEMPORAL GRAPH NEURAL NETWORK FOR AIR QUALITY FORECASTING AND MITIGATION ANALYSIS}
\newcommand\cTitleShort{Wind-Aware ST-GNN}
...
\renewcommand\cSubmittedI{Aman Singh}
\renewcommand\cSubmittedII{Avinash Joshi}
\renewcommand\cSubmittedIII{Kaushik Rayamajhi}
\renewcommand\cSubmittedIV{Nirika Lamichhane}  % Leave empty for 3 authors, or add 4th author name

\renewcommand\cSubmittedIRoll{(THA079BCT002)}
\renewcommand\cSubmittedIIRoll{(THA079BCT007)}
\renewcommand\cSubmittedIIIRoll{(THA079BCT018)}
\renewcommand\cSubmittedIVRoll{(THA079BCT024)}  % Leave empty for 3 authors, or add 4th roll number
...
\newcommand\cDateFull{June 3, 2026}
